...
use crate::{modules::public::{auth::infrastructure::jwt::claim::Claims, payment::{application::{dto::{create_budget_payment::CreateBudgetPaymentDto, create_visit_payment::CreateVisitPaymentDto, find_payment::FindPaymentDto, payment_response::PaymentResponse, webhook_event_request::WebhookEventRequest}, service::payment_service::PaymentService, usecase::usecase::UseCase}, domain::{entity::service_payment::ServicePayment, repository::{payment_repository::PaymentRepository, service_repository::ServiceRepository}}}}, shared::{domain::service::payment_budget_service::PaymentBudgetService, infra::{error::AppError, service::notification_service::NotificationService}}};
...
pub struct PaymentAppState {
    ...
    pub find_payment: Arc<dyn UseCase<(Claims, String, String), Result<ServicePayment, AppError>>>,
