...
use crate::{modules::public::{auth::infrastructure::jwt::claim::Claims, service::{application::{dto::{create_service_dto::CreateServiceDto, schedule_service_dto::{ScheduleServiceDto, ScheduleServiceResponse}, service_dto::ServiceDto}, usecase::UseCase}, domain::repository::{address_repository::AddressRepository, consultant_repository::ConsultantRepository, service_repository::ServiceRepository}}}, shared::infra::error::AppError};
...
pub struct ServiceAppState {
    ...
    pub schedule_service: Arc<dyn UseCase<(Claims, ScheduleServiceDto), Result<ScheduleServiceResponse, AppError>>>
}